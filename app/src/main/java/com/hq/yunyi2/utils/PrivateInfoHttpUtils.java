...
public class PrivateInfoHttpUtils {
    private static String PATH = "http://115.159.191.125:8080/YunYiServer/servlet/PrivateInfoAction";
    private static URL url;

    public PrivateInfoHttpUtils() {
