...
public class AncestorInfoHttpUtils {
    private static String PATH = "http://115.159.191.125:8080/YunYiServer/servlet/AncestorInfoAction";
    private static URL url;

    public AncestorInfoHttpUtils() {
